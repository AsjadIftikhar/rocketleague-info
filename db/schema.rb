...
ActiveRecord::Schema[7.0].define(version: 2022_09_27_071139) do
  ...
  create_table "display_pictures", force: :cascade do |t|
    t.string "imageable_type", null: false
    t.bigint "imageable_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["imageable_type", "imageable_id"], name: "index_display_pictures_on_imageable"
  end
  ...
  create_table "score_records", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["match_id"], name: "index_score_records_on_match_id"
    t.index ["player_id"], name: "index_score_records_on_player_id"
    t.index ["team_id"], name: "index_score_records_on_team_id"
  end
  ...
  create_table "user_follow_matches", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "hours_before_notification"
