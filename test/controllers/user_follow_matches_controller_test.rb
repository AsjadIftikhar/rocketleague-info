...
class UserFollowMatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_follow_match" do
    assert_difference("UserFollowMatch.count") do
      post user_follow_matches_url, params: { user_follow_match: { hours_before_notification: @user_follow_match.hours_before_notification } }
    end
  ...
  test "should update user_follow_match" do
    patch user_follow_match_url(@user_follow_match), params: { user_follow_match: { hours_before_notification: @user_follow_match.hours_before_notification } }
